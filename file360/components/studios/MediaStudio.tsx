  ...
  return (
    <section className="editor-grid">
      ...
      <div className="controls-panel">
        <div className="control-heading"><div><p className="section-kicker">Vídeo e áudio</p><h3>{info ? "Escolha o resultado" : "Lendo codecs"}</h3></div><span>{info ? format === "gif" ? "Entrada até 250 MB · trecho de 12 s" : `Até ${Math.round(info.maxBytes / 1024 / 1024)} MB · ${Math.round(info.maxSeconds / 60)} min` : "Verificando armazenamento"}</span></div>
        {info?.expandedStorage && format !== "gif" && <div className="note-box"><strong>Modo ampliado disponível</strong><p>O resultado é gravado temporariamente no armazenamento privado do navegador para reduzir o uso de memória.</p></div>}
