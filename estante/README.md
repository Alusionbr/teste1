...
| **Alvos pelo dedo** | O tamanho dos botões passou a ser decidido pela capacidade de toque, não pela largura da tela: telefone deitado e tablet na estante ganham alvos grandes, e no mouse o compacto continua. Deitado, com a letra andando, o cabeçalho e a tira de seções recolhem para sobrar tela — voltam no toque, que é o mesmo gesto que já pausa. |
| **Juntar ao aberto** | Ao importar um arquivo, além de **Adicionar** (guarda como repertórios separados) e **Substituir**, existe **Juntar ao aberto**: acrescenta as músicas ao repertório em uso, sem duplicar. É o que serve para receber a lista do ensaio toda semana — e é o mesmo que o link compartilhado sempre fez. |
